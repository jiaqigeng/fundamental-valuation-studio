...
- Ongoing work note: The current requested dashboard layout/copy and market-context polish changes are verified, including the negative-performance color treatment. Resume `dash-004` next unless the user asks for another narrow dashboard exception update.
