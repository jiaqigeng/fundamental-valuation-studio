...
- The landing page also exposes a direct CTA to `frontend/src/app/valuation/page.tsx`, giving the valuation workstream its own top-level entry route even before the full calculator UI is complete.
