...
def test_build_income_statement_waterfall_handles_negative_net_income() -> None:
    steps = _build_income_statement_waterfall_from_values(
        info={
            "totalRevenue": 12_000_000_000,
            "netIncomeToCommon": -1_400_000_000,
        },
        statement_values={
            "cost_of_revenue": 9_200_000_000,
            "gross_profit": 2_800_000_000,
            "operating_expense": 4_100_000_000,
            "operating_income": -1_300_000_000,
            "tax_provision": -300_000_000,
        },
    )
    ...
    assert [step.model_dump() for step in steps] == [
        ...
        },
        {
            "label": "Other Income / Cost",
            "value": -400000000.0,
            "display_value": "-$400.0M",
            "step_type": "delta",
        },
        {
            "label": "Taxes",
            "value": 300000000.0,
            "display_value": "$300.0M",
            "step_type": "delta",
        },
        {
            "label": "Net Profits",
