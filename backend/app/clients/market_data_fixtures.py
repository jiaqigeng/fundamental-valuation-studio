...
FIXTURE_WORKSPACES: dict[str, CompanyWorkspaceSnapshot] = {
    ...
    "LOSS": CompanyWorkspaceSnapshot(
        ticker="LOSS",
        name="Loss Example Holdings",
        sector="Industrials",
        summary=(
            "Loss Example Holdings is a fixture-only company used to verify the "
            "dashboard's loss-making income-statement rendering paths."
        ),
        workspace_tagline=(
            "Fixture-backed workspace used to verify negative net profit chart behavior."
        ),
        current_price_display="$8.42",
