...
FIXTURE_WORKSPACES: dict[str, CompanyWorkspaceSnapshot] = {
    "AAPL": CompanyWorkspaceSnapshot(
        ...
        quote_details=[
            ...
            QuoteDetail(label="Profit Margin", value="24.30%"),
            QuoteDetail(label="Operating Margin", value="31.18%"),
    ...
    "KO": CompanyWorkspaceSnapshot(
        ...
        quote_details=[
            ...
            QuoteDetail(label="Profit Margin", value="22.16%"),
            QuoteDetail(label="Operating Margin", value="30.27%"),
    ...
    "MSFT": CompanyWorkspaceSnapshot(
        ...
        quote_details=[
            ...
            QuoteDetail(label="Profit Margin", value="35.96%"),
            QuoteDetail(label="Operating Margin", value="44.64%"),
