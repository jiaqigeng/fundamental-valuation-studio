...
FIXTURE_WORKSPACES: dict[str, CompanyWorkspaceSnapshot] = {
    "AAPL": CompanyWorkspaceSnapshot(
        ...
        quote_details=[
            ...
            QuoteDetail(label="Trailing Dividend", value="0.96 (0.45%)"),
    ...
    "KO": CompanyWorkspaceSnapshot(
        ...
        quote_details=[
            ...
            QuoteDetail(label="Trailing Dividend", value="1.94 (3.12%)"),
    ...
    "MSFT": CompanyWorkspaceSnapshot(
        ...
        quote_details=[
            ...
            QuoteDetail(label="Trailing Dividend", value="3.32 (0.79%)"),
