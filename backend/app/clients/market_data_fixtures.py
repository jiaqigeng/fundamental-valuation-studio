    ...
    "AAPL": CompanyWorkspaceSnapshot(
        ...
        performance_chart=[
            PerformanceSeries(
                ...
                line_color="#21409A",
                points=[
                    PerformancePoint(label="Mar 18", value=100.0),
                    PerformancePoint(label="Mar 24", value=99.4),
                    PerformancePoint(label="Mar 31", value=101.8),
                    PerformancePoint(label="Apr 7", value=103.6),
                    PerformancePoint(label="Apr 14", value=105.9),
                    PerformancePoint(label="Apr 18", value=108.2),
                ],
            ),
            PerformanceSeries(
                label="S&P 500",
                ...
                points=[
                    PerformancePoint(label="Mar 18", value=100.0),
                    PerformancePoint(label="Mar 24", value=99.8),
                    PerformancePoint(label="Mar 31", value=101.1),
                    PerformancePoint(label="Apr 7", value=102.7),
                    PerformancePoint(label="Apr 14", value=104.1),
                    PerformancePoint(label="Apr 18", value=105.0),
                ],
            ),
            PerformanceSeries(
                label="Technology sector benchmark",
                ...
                points=[
                    PerformancePoint(label="Mar 18", value=100.0),
                    PerformancePoint(label="Mar 24", value=101.2),
                    PerformancePoint(label="Mar 31", value=103.8),
                    PerformancePoint(label="Apr 7", value=105.4),
                    PerformancePoint(label="Apr 14", value=107.9),
                    PerformancePoint(label="Apr 18", value=109.6),
                ],
            ),
        ],
    ),
    "KO": CompanyWorkspaceSnapshot(
        ...
        performance_chart=[
            PerformanceSeries(
                ...
                points=[
                    PerformancePoint(label="Mar 18", value=100.0),
                    PerformancePoint(label="Mar 24", value=100.7),
                    PerformancePoint(label="Mar 31", value=101.3),
                    PerformancePoint(label="Apr 7", value=102.2),
                    PerformancePoint(label="Apr 14", value=103.1),
                    PerformancePoint(label="Apr 18", value=104.4),
                ],
            ),
            PerformanceSeries(
                label="S&P 500",
            ...
            PerformanceSeries(
                ...
                points=[
                    PerformancePoint(label="Mar 18", value=100.0),
                    PerformancePoint(label="Mar 24", value=100.4),
                    PerformancePoint(label="Mar 31", value=101.2),
                    PerformancePoint(label="Apr 7", value=102.1),
                    PerformancePoint(label="Apr 14", value=103.0),
                    PerformancePoint(label="Apr 18", value=103.8),
                ],
            ),
        ],
    ),
    "MSFT": CompanyWorkspaceSnapshot(
        ...
        performance_chart=[
            PerformanceSeries(
                ...
                points=[
                    PerformancePoint(label="Mar 18", value=100.0),
                    PerformancePoint(label="Mar 24", value=101.6),
                    PerformancePoint(label="Mar 31", value=103.1),
                    PerformancePoint(label="Apr 7", value=105.8),
                    PerformancePoint(label="Apr 14", value=107.2),
                    PerformancePoint(label="Apr 18", value=110.5),
                ],
            ),
            PerformanceSeries(
                label="S&P 500",
